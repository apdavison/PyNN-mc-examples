"""
This script is essentially identical to "network_ring.py"
...
plt.ylabel("v (mV)")
plt.legend()
plt.savefig("results/ring_network_arbor_recipe.png")

np.savetxt(
    "results/ring_network_arbor_recipe.original_data",
